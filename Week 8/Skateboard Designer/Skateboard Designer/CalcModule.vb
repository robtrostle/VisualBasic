Module CalcModule
    ...
    Public frmDecks As New Decks
    Public frmWheels As New Wheels
    Public frmTrucks As New Trucks
    Public frmMiscellaneous As New Miscellaneous

    'Global string to hold selected item
